...
//assets loading
function carousel_enqueue_block_assets() {
	wp_register_style( 'slick', EG_PLUGIN_URL . "/blocks/carousel/slick.css", array(), time() );
	wp_register_style( 'eg-carousel-style', EG_PLUGIN_URL . "/blocks/carousel/eg-carousel-style.css", array(), time() );

	wp_register_script( 'slick', EG_PLUGIN_URL . "/blocks/carousel/slick.js", array('jquery'), time(), true );
	wp_register_script( 'eg-carousel-script', EG_PLUGIN_URL . "/blocks/carousel/eg-carousel-script.js", [ 'jquery', 'acf' ],time(),true );
}

function eg_carousel_assets( $block_content, $block ) {
	// Check if the specific block is being rendered
    if ( 'acf/eg-carousel' === $block['blockName']) {
		carousel_enqueue_block_assets();
	}
	return $block_content;
}
add_filter( 'render_block', 'eg_carousel_assets', 10, 2 );
